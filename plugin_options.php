...
class changeproducts_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('changeproducts', 'changeproducts', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="changeproducts"></div>';
  }
...
$changeproducts_options = new changeproducts_options();
$changeproducts_options->init();