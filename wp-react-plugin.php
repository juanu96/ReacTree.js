<?php
/*
Plugin Name: changeproducts
Description: Use the [changeproducts] shortcode to display the plugin
Version: 0.0.1
...
$changeproducts = new changeproducts();
$changeproducts->init();

function changeproducts_shortcode( $atts ) {
  ...
  return "<div id='changeproducts'></div>";
}

add_shortcode( 'changeproducts', 'changeproducts_shortcode' );